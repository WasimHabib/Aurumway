...
function Home() {
  ...
  return (
    <>
    <h1 className="phoneMessage">Please Open the Website on a Desktop, Laptop, or Tablet </h1>
  <div className="phoneHider">
    
    <div className="navMain">
                <img src="potential_map_gold_logo.jpg" alt="" className="companyLogo" />
                <Button type="INFO" id="" className='navButton' text="Home" onClick = {() => {scrollPage(0)}}/>
                <Button type="INFO" id="" className='navButton' text="About" onClick = {() => {scrollPage(1)}}/>
                <Button type="INFO" id="" className='navButton' text="Contact" onClick = {() => {scrollPage(2)}}/>
    </div>
    <div ref={backDropRef} style={BackDropStyles} className='cont' >
        ...
        <div ref={contactRef} style={ContactStyles} className='scroll-area'>3</div>
    </div>
