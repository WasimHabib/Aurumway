    ...
    if(props.hasFooter){
        return (
            <div className={styles.container} style={inlineStyle}>
                    ...
                    <div ref={headerRef} className={styles.header} style={headerStyle} onClick={toggleInfoBox} >
                        <img className={styles.headerIcon} style={iconStyle} ref={iconRef} src="/cog_golden.png" />
                        <div className={styles.titleContainer}>
                            <span ref={titleRef} className={title}>This is the title</span>
                        </div>
                    ...
                    <div ref={footerRef} className={styles.footer} style={{height: '15%', backgroundColor: colors.colorQuarternary}}>
